...
@interface VisionWebViewController ()
...
@implementation VisionWebViewController
...
- (IBAction)connectClicked:(id)sender
{
    ...
    hub = [connection createProxy:@"SingalRTest.Chat"];
...
- (void)addMessage:(id)message
{
    [messagesReceived insertObject:[NSString stringWithFormat:@"Message: %@",message] atIndex:0];
